    ...
    <main className="pilot-page">
      <div className="container">
        ...
        <form className="pilot-form" action="https://formsubmit.co/martinezeno@gmail.com" method="POST">
          ...
          <div className="pilot-submit"><p>By submitting this form, you agree that ZenLabs may use the information provided to contact you about BuildWise AI partnership opportunities. This form is an expression of interest only and does not constitute an offer of securities or an investment agreement.</p><button className="btn btn-primary" type="submit">EXPLORE PARTNERSHIP</button><p className="form-note">Please do not send funds at this stage. Funding instructions will only be provided after the appropriate structure and documentation have been agreed upon.</p></div>
        </form>
      </div>
    </main>
  );
